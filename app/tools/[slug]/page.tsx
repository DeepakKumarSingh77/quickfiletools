...
//   return (
//     <main className="min-h-screen bg-gray-50 px-5 py-6 sm:px-8">
//       <div className="mx-auto max-w-5xl">
//         <Link
//           href="/"
//           className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-bold shadow-sm"
//         >
//           <ArrowLeft size={16} />
//           All tools
//         </Link>

//         <section className="mt-8 rounded-lg border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
